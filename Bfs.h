...
int expand2(Frontier**, Frontier**, Frontier**, int, NodeIndex*,NodeIndex*, Buffer*,int, int);
int bidirectional2(Frontier** ,Frontier** ,Frontier** ,int , NodeIndex* , Buffer* , int , NodeIndex* , Buffer* ,int );
